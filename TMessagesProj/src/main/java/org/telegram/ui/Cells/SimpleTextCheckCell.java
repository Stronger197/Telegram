...
public class SimpleTextCheckCell extends FrameLayout {
    ...
    public static final Property<SimpleTextCheckCell, Float> ANIMATION_PROGRESS = new AnimationProperties.FloatProperty<SimpleTextCheckCell>("animationProgress") {
        @Override
        public void setValue(SimpleTextCheckCell object, float value) {
            object.setAnimationProgress(value);
            object.invalidate();
        }

        @Override
        public Float get(SimpleTextCheckCell object) {
            return object.animationProgress;
        }
    };

    public SimpleTextCheckCell(Context context) {
        this(context, 21);
    }

    public SimpleTextCheckCell(Context context, int padding) {
        this(context, padding, false);
    }

    public SimpleTextCheckCell(Context context, int padding, boolean dialog) {
        super(context);
